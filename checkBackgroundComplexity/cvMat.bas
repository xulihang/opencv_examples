...
Public Sub empty As Boolean
	Return matJO.RunMethod("empty",Null)
End Sub

Public Sub copyTo(roi As cvMat)
	matJO.RunMethod("copyTo",Array(roi.JO))
End Sub

Public Sub copyToWithMask(roi As cvMat,mask As cvMat)
